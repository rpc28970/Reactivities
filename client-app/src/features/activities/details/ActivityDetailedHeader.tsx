        ...
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                {activity.isHost ? (
                    ...
                    <Button loading={loading} onClick={updateAttendance}>Cancel</Button>
                ) : (
                    <Button disabled={activity.isCancelled} loading={loading} onClick={updateAttendance} color='teal'>Join</Button>
                )}
            </Segment>
        </Segment.Group>
    )
